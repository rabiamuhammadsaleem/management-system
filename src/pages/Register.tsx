...
export default function Register({ onNavigateToLogin }: RegisterProps) {
  ...
  return (
    <div id="register-container" className="min-h-screen w-full flex items-center justify-center bg-[#050505] text-[#e5e5e5] px-4">
      {/* Background Grid */}
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-xs uppercase tracking-wider text-zinc-500 font-semibold">
            NEXUS HR ADMINISTRATIVE ENROLLMENT
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <div className="space-y-4">
            {/* Full Name */}
            <div>
              <label htmlFor="reg-name" className="block text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-2">
                Full Name
              </label>
            ...
            {/* Email Address */}
            <div>
              <label htmlFor="reg-email" className="block text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-2">
                Work Email Address
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-zinc-600">
            ...
            {/* Password */}
            <div>
              <label htmlFor="reg-password" className="block text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-2">
                Password
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-zinc-600">
          ...
          >
            {loading ? "Creating Credentials..." : "Register Administrator"}
          </button>
        </form>
